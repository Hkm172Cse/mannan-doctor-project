                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                ?>
                               <?php if(is_array($chambers)): ?>
                                    <?php $__currentLoopData = $chambers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cham): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <ul id="cham_list">
                                            <li><strong><?php echo e($cham->name); ?></strong> <p><?php echo e($cham->address); ?>, <?php echo e($cham->time); ?></p></li>
                                        </ul>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('Backend.layouts.doctor.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Me\Mannan_vai_project\resources\views/Backend/doctor/profile.blade.php ENDPATH**/ ?>