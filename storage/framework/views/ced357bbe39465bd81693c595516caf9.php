        ...
        <div class="col-6 col-sm-4 col-lg-2">
            <div class="featured-boxes featured-boxes-modern-style-2 featured-boxes-modern-style-2-hover-only featured-boxes-modern-style-primary m-0 mb-4 pb-3">
                <div class="featured-box featured-box-no-borders featured-box-box-shadow">
                    <a href="<?php echo e(route('get.serial', ['chember'=>json_encode($chember), 'id'=>$info->id])); ?>" class="text-decoration-none">
                        <span class="box-content px-1 py-4 text-center d-block">
                            ...
                            <span class="font-weight-bold text-uppercase text-1 negative-ls-1 d-block text-dark pt-2"><?php echo e($chember->time); ?></span>
...
<?php echo $__env->make('Frontend.Layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Me\Mannan_vai_project\resources\views/Frontend/Pages/doctor/details.blade.php ENDPATH**/ ?>