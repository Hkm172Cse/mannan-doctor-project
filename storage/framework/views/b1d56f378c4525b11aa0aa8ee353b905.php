...
<body>
    ...
    <!-- Main navbar -->
    <?php echo $__env->make('Backend.layouts.admin.top', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- /main navbar -->
    ...
    <div class="page-content">
        ...
        <div class="sidebar sidebar-dark sidebar-main sidebar-expand-lg">
            ...
            <!-- Sidebar content -->
            <?php echo $__env->make('Backend.layouts.admin.left-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- /sidebar content -->
        ...
        <div class="content-wrapper">
            ...
            <!-- Page header -->
            <?php echo $__env->make('Backend.layouts.admin.breadcrumb', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- /page header -->
...
<?php /**PATH D:\Me\Doctor_Admin\resources\views/Backend/layouts/admin/master.blade.php ENDPATH**/ ?>