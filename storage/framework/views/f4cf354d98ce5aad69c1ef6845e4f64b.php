			...
			<ul class="nav flex-row justify-content-end order-1 order-lg-2">
				...
				<li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
					<a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
						...
						<p class="user-info">
							<span class="mx-lg-2"><?php echo e(Auth::guard('doctor')->user()->name); ?> <?php echo e(Auth::guard('doctor')->user()->last_name); ?></span>
							<small>Doctor's Account</small>
						</p>
					</a>

					<div class="dropdown-menu dropdown-menu-end">
						<a href="<?php echo e(route('doctor.profile')); ?>" class="dropdown-item">
						...
						<a href="<?php echo e(route('doc.logout')); ?>" class="dropdown-item">
    ...
    <!-- /default modal -->
<?php /**PATH D:\Me\Mannan_vai_project\resources\views/Backend/layouts/doctor/top.blade.php ENDPATH**/ ?>