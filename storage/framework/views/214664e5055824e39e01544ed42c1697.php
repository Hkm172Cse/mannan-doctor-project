...
<html lang="en">
	<head>
		...
		<link rel="apple-touch-icon" href="<?php echo e(asset('frontend/img/apple-touch-icon.png')); ?>">
		...
		<link rel="stylesheet" href="<?php echo e(asset('frontend/vendor/simple-line-icons/css/simple-line-icons.min.css')); ?>">
		...
		<link rel="stylesheet" href="<?php echo e(asset('frontend/css/theme-blog.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('frontend/css/theme-shop.css')); ?>">

		<!-- Demo CSS -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/css/demos/demo-auto-services.css')); ?>">


		<!-- Current Page CSS -->
		<link rel="stylesheet" href="<?php echo e(asset('frontend/vendor/circle-flip-slideshow/css/component.css')); ?>">
	...
	<body>		
		...
		<!-- Vendor -->
		<script src="<?php echo e(asset('frontend/js/jquery1-3.4.1.min.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/vendor/plugins/js/plugins.min.js')); ?>"></script>
		<!-- Bootstrap Js -->
		...
		<script src="<?php echo e(asset('frontend/vendor/circle-flip-slideshow/js/jquery.flipshow.min.js')); ?>"></script>
		<!-- Current Page Views -->
		<script src="<?php echo e(asset('frontend/js/views/view.home.js')); ?>"></script>
...
</html><?php /**PATH D:\Me\Mannan_vai_project\resources\views/Frontend/Layout/app.blade.php ENDPATH**/ ?>